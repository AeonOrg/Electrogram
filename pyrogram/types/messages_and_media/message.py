...
class Message(Object, Update):
    ...
    def __init__(
        ...
        *,
        ...
        chat_theme_updated: Any | None = None,
        chat_wallpaper_updated: Any | None = None,
        contact_registered: types.ContactRegistered | None = None,
        gift_code: Any | None = None,
        user_gift: types.UserGift | None = None,
        star_gift: Any | None = None,
